...
{
    DL_I2C_startControllerTransfer(I2C_0_INST, address, DL_I2C_CONTROLLER_DIRECTION_TX, 0);
    while (DL_I2C_getControllerStatus(I2C_0_INST) & DL_I2C_CONTROLLER_STATUS_BUSY);

    return !(DL_I2C_getControllerStatus(I2C_0_INST) & DL_I2C_CONTROLLER_STATUS_ERROR);
}
