...
#define IPS200_SCL_PIN_SPI               ( SPI1_SCK_B9      )                     // 硬件 SPI SCK 引脚
#define IPS200_SDA_PIN_SPI               ( SPI1_MOSI_B8     )                      // 硬件 SPI MOSI 引脚
//====================================================硬件 SPI 驱动====================================================
#endif
// 如果使用的是单排排针的两寸屏幕 SPI 驱动控制引脚 可以修改
...
#define IPS200_RST_PIN_SPI              ( B10 )                                  // 液晶复位引脚定义
#define IPS200_DC_PIN_SPI               ( B11 )                                // 液晶命令位引脚定义
#define IPS200_CS_PIN_SPI               ( B14 ) 
#define IPS200_BLk_PIN_SPI              ( B26 ) 
